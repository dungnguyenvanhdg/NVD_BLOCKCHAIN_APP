...
public class DungnvChain {
    ...
    public static DungnvWallet walletA; //Ví A
    public static DungnvWallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new DungnvWallet();
        walletB = new DungnvWallet();
        DungnvWallet coinbase = new DungnvWallet();
